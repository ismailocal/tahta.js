...
export const STYLE_PRESETS: Record<string, any> = {
  ...
  'arrow-curved': { stroke: '#e5e7eb', strokeWidth: 1, roughness: 0, edgeStyle: 'curved',   startArrowhead: 'none',    endArrowhead: 'arrow',    opacity: 1 },
  'arrow-filled': { stroke: '#e5e7eb', strokeWidth: 1, roughness: 0, edgeStyle: 'straight', startArrowhead: 'none',    endArrowhead: 'triangle', opacity: 1 },
